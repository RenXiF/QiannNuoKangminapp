...
/**
                                       * 客服电话
                                       */
_vue.default.prototype.phone = '15323232222';
...
/**
    ...
    * @param {Object} sn
    */
_vue.default.prototype.balance_pay = function (sn, isback) {
  var that = this;
  var jsonData = {};
  jsonData.user_id = utils.getUser('id');
  jsonData.sn = sn;
  utils.showloading();
  utils.getApi('/api/order/balance_pay', jsonData, function (res) {
    uni.hideLoading();
    console.log(res);
    if (res.code == 1) {
      uni.showToast({
...
/**
    ...
    * @param {Object} msg
    */
_vue.default.prototype.doUrl = function (url, param, islogin, msg) {
  url = url.replace(" ", "");
  if (url == '#' || url == '' || url == 'http://' || url == 'https://') {
    return;
  }
  var urlparam = utils.urlToarray(url.replace("??", "?"));
  var params = utils.parseParam(param).toLowerCase() + '&' + utils.parseParam(urlparam).toLowerCase();
  ...
  var urls = url.indexOf("?") < 0 ? url : url.substr(0, url.indexOf('?'));
  var uri = urls.indexOf("pages/") < 0 ? "/pages/" + urls : '/' + urls;
...
/**
    ...
    * @param {Object} field
    */
_vue.default.prototype.getLocationInfo = function (field) {
  var info = uni.getStorageSync('location');
  // console.log(info)
  if (info == '' || info == null) {
    return null;
  }
...
/**
    ...
    * @param {Object} field
    */
_vue.default.prototype.getConfig = function (field) {
...
/**
    * 获取系统平台
    */
_vue.default.prototype.getPlatform = function getPlatform() {
...
/**
    * 获取系统信息
    */
_vue.default.prototype.getSys = function getSys(field) {
...
/**
    ...
    * -- param id 显示第几张图片
    */
_vue.default.prototype.openImg = function openImg(urls, id) {
...
_vue.default.prototype.getImg = function (url) {
...
/**
    ...
    * @param {Object} url
    */
_vue.default.prototype.doSwitch = function (url) {
  uni.switchTab({
    url: url });
...
component.options.__file = "资料/程序资料/黔诺康/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 6 */
/*!*******************************************************!*\
  !*** D:/资料/程序资料/黔诺康/App.vue?vue&type=script&lang=js& ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/资料/程序资料/黔诺康/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 8 */
/*!****************************************************************!*\
  !*** D:/资料/程序资料/黔诺康/App.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 9 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/资料/程序资料/黔诺康/App.vue?vue&type=style&index=0&lang=scss& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
